...
//--------------
float notas_tg(){
	int n_tg_e; //nota final do trabalho de grupo escrito de 5%
	int n_tg_eoe;//nota final do trabalho de grupo escrito,oral ou experimental
...
//----------------------
float notas_participacao(){
int n_p; //nota participacao
float n_p_final; //nota de participacao final ao aplicar o seu peso de 5%
	printf("Nota de Participacao/Contribuicoes(5%): ");
		scanf("%d",&n_p);
n_p_final=n_p * 0.05;
